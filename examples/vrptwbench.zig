...
fn bksFor(name: []const u8) ?Bks {
    const table = [_]struct { []const u8, usize, f64 }{
        ...
        // Gehring-Homberger 400/1000, first instance per class; BKS from the
        // SINTEF TOP tables (lexicographic: fewest vehicles, then distance).
        .{ "c1_4_1", 40, 7152.02 }, .{ "c2_4_1", 12, 4116.05 },
        .{ "r1_4_1", 40, 10372.31 }, .{ "r2_4_1", 8, 9210.15 },
        .{ "rc1_4_1", 36, 8571.32 }, .{ "rc2_4_1", 11, 6682.37 },
        .{ "c1_10_1", 100, 42478.95 }, .{ "c2_10_1", 30, 16879.24 },
        .{ "r1_10_1", 100, 53380.18 }, .{ "r2_10_1", 19, 42182.57 },
        .{ "rc1_10_1", 90, 45830.62 }, .{ "rc2_10_1", 20, 30276.27 },
    };
    for (table) |row| {
