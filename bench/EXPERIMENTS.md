...
| 28 | CVRP transposed rows in SISR recreate | The two column-wise loads per neighbour (, ) become row reads of a transposed copy | `b9a961b`, reverted `a8946fc` | `9be2099` | idle box, interleaved: old 2030 / 2041, new 2062 / 2051 ms | +1.6% / +0.5% | DEAD | Rows p and m are fetched anyway for the two route arcs, same failure mode as experiment 20 |
